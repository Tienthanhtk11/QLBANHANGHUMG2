...
namespace DAL
{
    public class tb_PhongBanDAL
    {
        ...
        {
            return Unility.GetDataTable("SELECT MaPhongBan 'Mã phòng ban',TenPhongBan 'Tên phòng ban' FROM tb_PhongBan where MaPhongBan like '%"+MaPhongBan+ "%' or TenPhongBan like '%"+ MaPhongBan + "%'");
        }
    }
}
