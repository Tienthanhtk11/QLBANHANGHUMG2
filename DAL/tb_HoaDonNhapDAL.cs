...
namespace DAL
{
	public class tb_HoaDonNhapDAL
	{
        ...
        {
            return Unility.GetDataTable(string.Format(@"SELECT MaHoaDonNhap 'Mã hóa đơn nhập',
                                                        tb_NhaCungCap.TenNhaCungCap 'Nhà cung cấp',
                                                        tb_NhanVien.TenNhanVien 'Nhân viên',
                                                        NgayLap 'Ngày lập' 
                                                        FROM tb_HoaDonNhap join tb_NhaCungCap on tb_HoaDonNhap.MaNhaCungCap = tb_NhaCungCap.MaNhaCungCap join tb_NhanVien on tb_HoaDonNhap.MaNhanVien =tb_NhanVien.MaNhanVien
                                                        WHERE 
